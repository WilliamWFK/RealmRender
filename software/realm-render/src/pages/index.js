              ...
              */}
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div class="formInput">
                  ...
                  <input type="range" min="20" max="60" step="2" defaultValue={formData.width} onChange={(e) =>setFormData({ ...formData, width: parseInt(e.target.value) })} id="width" name="width"></input>
                </div>
                <div class="formInput">
                  <label htmlFor="height">Height: {formData.height}</label>
                  <input type="range" min="20" max="60" step="2" defaultValue={formData.height} onChange={(e) =>setFormData({ ...formData, height: parseInt(e.target.value) })} id="height" name="height"></input>
                </div>
